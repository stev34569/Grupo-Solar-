...
import 'confirmacion_cita_model.dart';
export 'confirmacion_cita_model.dart';

class ConfirmacionCitaWidget extends StatefulWidget {
  const ConfirmacionCitaWidget({Key? key}) : super(key: key);
...
class _ConfirmacionCitaWidgetState extends State<ConfirmacionCitaWidget> {
  late ConfirmacionCitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmacionCitaModel());
