...
import 'cambio_contrasenna_model.dart';
export 'cambio_contrasenna_model.dart';

class CambioContrasennaWidget extends StatefulWidget {
  const CambioContrasennaWidget({Key? key}) : super(key: key);

  @override
  _CambioContrasennaWidgetState createState() =>
      _CambioContrasennaWidgetState();
}

class _CambioContrasennaWidgetState extends State<CambioContrasennaWidget> {
  late CambioContrasennaModel _model;
                                              ...
                                              child: Padding(
                                                padding:
                                                    MediaQuery.viewInsetsOf(
                                                        context),
                                                child: ConfirmarContraWidget(
                                                  nuevaContrasena: _model
                                                      .nuevaContrasenaController
                                                      .text,
                                                  antiguaContrasena: _model
                                                      .antiguaContrasenaController
                                                      .text,
                                                ),
                                              ),
                                            );
