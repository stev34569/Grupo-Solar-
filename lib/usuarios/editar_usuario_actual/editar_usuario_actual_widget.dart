...
import 'editar_usuario_actual_model.dart';
export 'editar_usuario_actual_model.dart';

class EditarUsuarioActualWidget extends StatefulWidget {
  const EditarUsuarioActualWidget({
    Key? key,
    required this.usuarioSeleccionado,
  }) : super(key: key);

  final DocumentReference? usuarioSeleccionado;

  @override
  _EditarUsuarioActualWidgetState createState() =>
      _EditarUsuarioActualWidgetState();
}

class _EditarUsuarioActualWidgetState extends State<EditarUsuarioActualWidget> {
  late EditarUsuarioActualModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarUsuarioActualModel());
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.usuarioSeleccionado!
                              .update(createUsersRecordData(
                            displayName: _model.txtNombreController.text,
                            apellido: _model.txtApellidoController.text,
