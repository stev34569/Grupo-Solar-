...
class EditarUsuariosWidget extends StatefulWidget {
  ...
  @override
  _EditarUsuariosWidgetState createState() => _EditarUsuariosWidgetState();
}
...
class _EditarUsuariosWidgetState extends State<EditarUsuariosWidget> {
  ...
  void initState() {
    ...
    _model.txtApellidoController ??=
        TextEditingController(text: widget.usuarioSeleccionado?.apellido);
    _model.txtTelefonoController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.usuarioSeleccionado?.phoneNumber,
      '1',
    ));
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model.dropDownRolValueController ??=
                              ...
                              _model.dropDownRolValue ??= widget
                                  .usuarioSeleccionado
                                  ?.hasRol()
                                  ?.toString(),
                            ),
                            options: ['Empleado', 'Cliente', 'Administrador'],
                            onChanged: (val) =>
                                setState(() => _model.dropDownRolValue = val),
                            width: 336.31,
                            height: 50.0,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await widget.usuarioSeleccionado!.reference
                              ...
                              rol: () {
                                if (_model.dropDownRolValue == 'Empleado') {
                                  return 'employee';
                                } else if (_model.dropDownRolValue ==
                                    'Cliente') {
                                  return 'cliente';
                                } else if (_model.dropDownRolValue ==
                                    'Administrador') {
