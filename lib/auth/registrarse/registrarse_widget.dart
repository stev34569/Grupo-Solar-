        ...
        body: SafeArea(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(30.0, 80.0, 0.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                              onTap: () => setState(
                                () => _model.txtRegistroPasswordVisibility =
                                    !_model.txtRegistroPasswordVisibility,
                              ),
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                              onTap: () => setState(
                                () => _model
                                        .txtRegistroConfirmarPasswordVisibility =
                                    !_model
                                        .txtRegistroConfirmarPasswordVisibility,
                              ),
                              focusNode: FocusNode(skipTraversal: true),
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.txtRegistroPasswordController.text !=
                              _model.txtRegistroConfirmarPasswordController
                                  .text) {
                          ...
                          final user = await authManager.createAccountWithEmail(
                            context,
                            _model.txtRegistroEmailController.text,
                            _model.txtRegistroPasswordController.text,
                          );
                          if (user == null) {
                            return;
                          }
                          ...
                          await UsersRecord.collection
                              ...
                              .update(createUsersRecordData(
                                displayName:
                                    _model.txtRegistroNombreController.text,
                                apellido:
                                    _model.txtRegistroApellidoController.text,
                                rol: 'cliente',
                                photoUrl:
